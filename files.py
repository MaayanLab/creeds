...
class ANNOTFile(File):
	# Class for .annot file of a platform
	def __init__(self, accessionOrFile):
		accessionOrFile = accessionOrFile.replace('.annot', '')
		super(ANNOTFile, self).__init__(accessionOrFile, 'annot/', '.annot')
